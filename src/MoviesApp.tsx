...
const MoviesApp = () => {
    ...
    const handleDefaultResults = () => {
        setFilteredMovieData(movieData.results);
    };

    return (
        <>
            <span className='header'>
              <SearchMovies handleSearchResults={handleSearchResults} handleDefaultResults={handleDefaultResults}/>
